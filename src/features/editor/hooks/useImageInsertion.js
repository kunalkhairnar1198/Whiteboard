  ...
  const handleImageUpload = useCallback(async (e) => {
    ...
    for (const file of Array.from(files)) {
      ...
      try {
        ...
        const scale = (img.width > MAX_INSERT_SIZE || img.height > MAX_INSERT_SIZE)
    ...
    e.target.value = '';
  }, [canvas, engine, counterRef, incrementElementCounter, setShowFilters, setShowLayers, safeSaveState]);
